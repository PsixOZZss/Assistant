...
- Добавлена нормализация и диагностика настроек openWakeWord threshold/frame/model.
- Подтверждение опасных действий теперь поддерживает повторную попытку через `confirmation.max_attempts`.
